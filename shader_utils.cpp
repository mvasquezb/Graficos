...
/**
 * Leer contenido de archivo de texto y devolverlo en char*
 */
...
/**
 * Imprime errores de compilacion de shaders en OpenGL
 */
...
/**
 * Compilar el Shader usando el código dado en la cadena "filename"
 */
